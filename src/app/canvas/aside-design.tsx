...
import AsideDesignPoint from './components/aside-design-point'
import AsideDesignRecords from './components/aside-design-records'
...
export default function AsideDesign() {
	...
	return (
		<>
			...
			{store.records.length > 0 && <AsideDesignRecords records={store.records} />}
		</>
	)
}
